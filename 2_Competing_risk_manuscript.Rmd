...
##################
### univariate ###    Univariate analysis of CSHR and SH 
##################
...
explanatory = c("dm", "frailty(site)") #Only one covariate at a time 
...
The PH assumption for the SH models was checked using the Schoenfeld-type residuals tailored for subdistribution hazards. Schoenfeld residual plots indicated the PH assumption was upheld (see Supplement) (** need to remove Lucenxia as the PH assumption was broken **)
