...
explanatory = c("PtRace", "Age2", "PtAssist", "dm", "brand", "frailty(site)")
...
The PH assumption for the SH models was checked using the Schoenfeld-type residuals tailored for subdistribution hazards. Schoenfeld residual plots indicated the PH assumption was upheld (see Supplement)
