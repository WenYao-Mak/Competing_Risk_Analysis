  ...
  mutate(
    ...
    site = factor(site) %>%
      fct_recode("Kedah" = "2", 
                 ...
                 "Sarawak" = "13", 
                 "KL" = "14") %>%
      ff_label("Treatment Centre (States)"),
